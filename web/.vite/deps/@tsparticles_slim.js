...
var BlendPlugin = class {
	...
	async getPlugin(container) {
		const { BlendPluginInstance } = await import("./BlendPluginInstance-CnhN7JD-.js");
...
var MovePlugin = class {
	...
	async getPlugin(container) {
		const { MovePluginInstance } = await import("./MovePluginInstance-DsI7noOI.js");
...
var InteractivityPlugin = class {
	...
	async getPlugin(container) {
		const { InteractivityPluginInstance } = await import("./InteractivityPluginInstance-B87qE63I.js");
...
var OverlapPlugin = class {
	id = "overlap";
	async getPlugin(container) {
		const { OverlapPluginInstance } = await import("./OverlapPluginInstance-Bod-qaAH.js");
...
var LinksPlugin = class {
	...
	async getPlugin(container) {
		const { LinkInstance } = await import("./LinkInstance-BZ_6B821.js");
